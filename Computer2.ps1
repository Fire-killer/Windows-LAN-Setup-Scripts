# PowerShell script for the second computer
...
# Configure static IP address for the second computer
...
# Inform the user
Write-Host "Static IP address and network sharing settings have been configured on the second computer."
